...
export const dict = {
  ...
  attendeesTitle: { it: "Presenti al F.A.T.", en: "F.A.T. Attendees", de: "F.A.T.-Teilnehmer", es: "Asistentes al F.A.T." },
  attendeesDesc: {
  ...
  generatePdf: { it: "Genera Report F.A.T.", en: "Generate F.A.T. Report", de: "F.A.T.-Bericht erstellen", es: "Generar informe F.A.T." },
  ...
  // Archivio F.A.T.
  archiveTitle: { it: "Archivio F.A.T.", en: "F.A.T. Archive", de: "F.A.T.-Archiv", es: "Archivo F.A.T." },
  archiveDesc: {
    it: "Tutti i F.A.T. salvati, suddivisi per stato. Puoi aprirli, duplicarli o eliminarli. L'archivio è salvato nel localStorage del browser (sorgente: src/lib/fat-context.tsx).",
    en: "All saved F.A.T. grouped by status. Open, duplicate or delete them. The archive is stored in the browser's localStorage (source: src/lib/fat-context.tsx).",
    de: "Alle gespeicherten F.A.T. nach Status gruppiert. Öffnen, duplizieren oder löschen. Das Archiv wird im localStorage des Browsers gespeichert (Quelle: src/lib/fat-context.tsx).",
    es: "Todos los F.A.T. guardados agrupados por estado. Abrir, duplicar o eliminar. El archivo se guarda en el localStorage del navegador (fuente: src/lib/fat-context.tsx).",
  },
  ...
  newFat: { it: "Nuovo F.A.T.", en: "New F.A.T.", de: "Neues F.A.T.", es: "Nuevo F.A.T." },
  ...
  loadFileTitle: {
    it: "Carica un F.A.T. salvato",
    en: "Load a saved F.A.T.",
    de: "Gespeichertes F.A.T. laden",
    es: "Cargar un F.A.T. guardado",
  },
  loadFileDesc: {
    it: "Scegli uno dei F.A.T. salvati in precedenza per aprirlo e continuare la compilazione.",
    en: "Choose one of the previously saved F.A.T. to open it and continue filling it in.",
    de: "Wählen Sie eines der zuvor gespeicherten F.A.T., um es zu öffnen und weiterzubearbeiten.",
    es: "Elige uno de los F.A.T. guardados anteriormente para abrirlo y continuar.",
  },
  noFats: { it: "Nessun F.A.T. in questa categoria.", en: "No F.A.T. in this category.", de: "Keine F.A.T. in dieser Kategorie.", es: "Ningún F.A.T. en esta categoría." },
  confirmDelete: {
    it: "Eliminare definitivamente questo F.A.T.?",
    en: "Permanently delete this F.A.T.?",
    de: "Diesen F.A.T. endgültig löschen?",
  ...
  reportGeneratedDone: {
    ...
    de: "Bericht erstellt — F.A.T. als abgeschlossen markiert.",
    es: "Informe generado — F.A.T. marcado como completado.",
  },
  untitledFat: { it: "F.A.T. senza titolo", en: "Untitled F.A.T.", de: "F.A.T. ohne Titel", es: "F.A.T. sin título" },
  activeFat: { it: "F.A.T. attivo", en: "Active F.A.T.", de: "Aktiver F.A.T.", es: "F.A.T. activo" },
